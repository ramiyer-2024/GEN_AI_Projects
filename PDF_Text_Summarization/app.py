...
#LLM slect
llm_type=st.selectbox("Select LLM",["Ollama-gemma","gpt-4o","gpt-4-turbo","gpt-4","mixtral-8x7b-32768","llama-3.3-70b-versatile","Gemma2-9b-It"])
...
def select_llm(llm_type):
    if llm_type=="Ollama-gemma":
        llm=Ollama(model="gemma:2b")
    elif llm_type=="gpt-4o" or llm_type=="gpt-4-turbo" or llm_type=="gpt-4":
        openai.api_key=openai_api_key
        llm=ChatOpenAI(model=llm_type, max_completion_tokens=300) 
    else:
        llm=ChatGroq(groq_api_key=groq_api_key,model_name=llm_type,max_tokens=300)
    return llm
